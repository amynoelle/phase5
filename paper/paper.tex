...
and \num{200} iterations of \command{cat-looper} (with \path{states.txt} serving as the input for the latter) both took approximately five seconds
on my computer.
